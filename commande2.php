                  ...
                  <form method="post" enctype="multipart/form-data">
                   <!--  <div class="left">  -->
                    <div class="modal-body">
                      ...
                      <p>Upadate your meal quantity!</p>
                      <div class="left">
                 ...
                 <!--  <div class="left">  -->
                  <div class="modal-body">      
                    ...
                    <div class="left">
                      ...
                      id="adress" placeholder="Enter your adress"   required disabled >
                    </div> 
                  ...
                  <div class="modal-footer" style="border-top: 0;">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal" style="margin-right: 15px">Cancel</button>
                     <button  class="btn btn-primary" type="submit" name="action" value="Modifier" style="background-color: #131230; border-color: #131230;     margin-right: -15px;">Proceed</button>
